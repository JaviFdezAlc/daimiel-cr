...
public class RejectRideRequestService implements RejectRideRequestUseCase {
    ...
    @Override
    @Transactional
    public void reject(RejectRideRequestCommand command) {
        ...
        rideRequest.reject(Instant.now(clock));
